...
fields to `struct ipu7_bus_device`, but that structure is allocated by the kernel's in-tree IPU7
...
give PSys its own debugfs directory, and keep the shared readiness flag at the in-tree structure
